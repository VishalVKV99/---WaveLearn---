        ...
        <div className="flex lg:flex-row  items-center justify-center gap-20 mt-40 mb-20 flex-col">
          ...
          <div className="w-[50%] flex flex-col text-white bg-blue-700 rounded-md p-20 gap-10 m-0">
            <div >
              ...
              <div className="text-white text-xl ml-8"><p>Our mission to assist in all possible vishalverma3242@gmail.com</p></div>
            </div>
            ...
            <div >
              ...
              <div className="text-white text-xl ml-8"><p>Mon-Fri from 9am to 5pm <br />+91-9525668125</p></div>
            </div>
          </div>
          {/* for get in touch */}
          <div className="w-[50%]">
